  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Patient Imformation Form </h2>
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="Age" className="block text-sm font-semibold leading-6 text-red-600">
              Age
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="Age" className=" text-sm font-semibold  text-red-600">
              Gender
            </label>
            <div className="mt-2.5 flex">
              ...
              <input
                ...
                id="gender"
                autoComplete="gender"
                className="block  ml-2 rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm shadow-blue-500 ring-1 ring-inset ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6"
              />
            </div>
            <div className="mt-2.5 flex ">
            <span>female</span>
          ...
          <div className="sm:col-span-2">
            <label htmlFor="address" className="block text-sm font-semibold leading-6 text-green-600">
         Address
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              <select
                id="country"
                name="country"
                className=" px-4 absolute inset-y-0 left-0 h-full rounded-md border-0 bg-transparent py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
              >
                <option>pak</option>
                <option>US</option>
                <option>CA</option>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-cyan-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
