...
const EmployeeList = () => {
  return (
    <div className="">
        <div className='flex gap-12 p-4 mt-10'>
            <div className='bg-gray-200 w-3/12 p-5 space-y-1 rounded-xl'>
...
<h2 className='text-gray-800 font-semibold'>Credit line Assignment </h2>
<button className='bg-gray-400 text-white px-4 py-[2px] rounded-lg'>23 Requests</button>

            </div>
            <div className='bg-gray-200 w-3/12 p-5 space-y-1 rounded-xl'>
<p><FaCodePullRequest className='bg-gray-600 text-5xl p-2 text-white rounded-3xl'></FaCodePullRequest></p>
{/* <p className='text-white'>Step 1</p> */}
<h2 className=' font-semibold'>Credit line Assignment </h2>
<button className='bg-gray-400  text-white px-4 py-[2px] rounded-lg'>in progress</button>
      ...
      <div className="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border">
        ...
        <div className="p-0">
          <table className="w-full mt-4 text-left table-auto min-w-max">
            <thead>
              <tr>
                {['Member', 'Number', 'Status', 'Date', 'age', 'gender','edit'].map((header, index) => (
                  <th
                    key={index}
