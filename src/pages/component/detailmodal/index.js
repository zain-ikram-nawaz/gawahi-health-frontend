...
export default function DetailModal({ itemId, setIsOpen }) {
  ...
  return (
    ...
    <div className="relative bg-gradient-to-br from-white via-gray-50 to-gray-100 p-8 rounded-xl shadow-xl w-3/4 max-w-3xl h-4/5 overflow-y-auto">
      <button
        onClick={() => {
          setIsOpen(false);
        }}
      ...
      <div className="space-y-5">
        <div className="flex justify-between items-center gap-10 border-b pb-2">
