...
<div class="h-screen md:flex">
	<div
		class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-700 to-blue-300 i justify-around items-center hidden">
		<div>
	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form class="bg-white">
			...
			<p class="text-sm font-normal text-gray-600 mb-7">Please register a account</p>
...
<Link href="/component/login"><span class="text-sm ml-2 hover:text-blue-500 cursor-pointer">Already have an account?</span></Link>
		</form>
	</div>
</div>
